     ...
     <div className="flex h-screen flex-col gap-4  md:flex-row">
       <Card className="flex h-[80%] w-full flex-col items-center overflow-visible p-4 md:w-4/12">
         ...
         <User
           ...
           description="anythingyouwantto@uct.edu"
           avatarProps={{
             src: "https://www.lstmed.ac.uk/sites/default/files/styles/mc-580-16x9-node/public/content/pages/images/UCT.jpeg?itok=O0dc31th",
             size: "lg",
             isBordered: true,
           }}
         />
       ...
       <h3 className="mx-4 font-bold">Students</h3>
         <Modal
           isOpen={isOpen}
             ...
             <form action={createCampaignAction}>
               ...
               <ModalBody>
                 ...
                 <Textarea
                   ...
                   placeholder="Any particular student details"
                   className="w-full"
                   required
                 />
                 <Input
